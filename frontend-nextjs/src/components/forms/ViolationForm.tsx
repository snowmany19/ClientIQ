...
export default function ViolationForm({ onSuccess, onCancel }: ViolationFormProps) {
  ...
  // Add workflow steps
  const workflowSteps = [
    { id: 1, title: 'Violation Details', description: 'Basic information' },
    { id: 2, title: 'Evidence & Photos', description: 'Documentation' },
    { id: 3, title: 'Location & GPS', description: 'Property location' },
